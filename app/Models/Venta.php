...
class Venta extends Model
{
    ...
    public function domicilioEntrega(): BelongsTo { return $this->belongsTo(DomicilioCliente::class, 'domicilio_entrega_id'); }
